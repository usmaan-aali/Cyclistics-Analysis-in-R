...
avg_ride_length <- read_csv("Cyclistic_Data_CSV/avg_ride_length.csv")
num_rides_by_day_of_week <- read_csv("Cyclistic_Data_CSV/num_rides_by_day_of_week.csv")
num_of_rides_by_time_of_day <- read_csv("Cyclistic_Data_CSV/num_rides_by_time_of_day.csv")
type_of_bike_used_by_user <- read_csv("Cyclistic_Data_CSV/type_of_bike_used_user_type.csv") 
...
colnames(num_of_rides_by_time_of_day) <- c("member_casual","time_of_day","number_of_rides")
colnames(type_of_bike_used_by_user) <- c("member_casual","type_of_ride","number_of_rides")
```

### Let's analyze the difference of bikes usage between cutomer types
...
### Conclusion
Overall casual rider is using the cyclistics bikes for more time than the annaul member.On the other way annual member preffer  classic bikes than casual rider. Annual member generate more profit for cyclistics, so they need to convince their casual rider to convert to annual member which will increase the company's profit margin.
